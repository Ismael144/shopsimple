...
const file_shopsimple_product_v1_product_proto_rawDesc = "" +
	...
	"\x0eListCategories\x12,.shopsimple.product.v1.ListCategoriesRequest\x1a-.shopsimple.product.v1.ListCategoriesResponse\"$\x82\xd3\xe4\x93\x02\x1e\x12\x1c/products/v1/list_categoriesB\xeb\x01\n" +
